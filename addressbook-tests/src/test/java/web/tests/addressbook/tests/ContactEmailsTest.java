...
public class ContactEmailsTest extends TestBase{
  ...
  public void testContactEmails(){
    ...
    MatcherAssert.assertThat(contact.getAllEmails(), Matchers.equalTo(merged(contactInfoFromEditForm)));

  }

  private String merged(ContactData contactInfoFromEditForm) {
    return Arrays.asList(contactInfoFromEditForm.getEmail(),contactInfoFromEditForm.getEmail2(),contactInfoFromEditForm.getEmail3()).stream()
