...
public class ContactPhoneTest extends TestBase{
  ...
  public void testContactPhones(){
    ...
    /*MatcherAssert.assertThat(contact.getHome_phone(), Matchers.equalTo(cleaned(contactInfoFromEditForm.getHome_phone())));
    MatcherAssert.assertThat(contact.getMobile_phone(), Matchers.equalTo(cleaned(contactInfoFromEditForm.getMobile_phone())));
    MatcherAssert.assertThat(contact.getWork_phone(), Matchers.equalTo(cleaned(contactInfoFromEditForm.getWork_phone())));*/
    MatcherAssert.assertThat(contact.getAllPhones(), Matchers.equalTo(merged(contactInfoFromEditForm)));

  }

  private String merged(ContactData contactInfoFromEditForm) {
    return Arrays.asList(contactInfoFromEditForm.getHome_phone(),contactInfoFromEditForm.getMobile_phone(),contactInfoFromEditForm.getWork_phone()).stream()
